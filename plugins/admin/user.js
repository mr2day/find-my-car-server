        ...
        config: {
            ...
            handler: function(request, reply) {
                Model.findOne({ _id: request.params.id }, function(err, dto) {
                    ...
                    // update
                    if (request.payload.firstName) dto.firstName = request.payload.firstName;
                    if (request.payload.lastName) dto.lastName = request.payload.lastName;
                    if (request.payload.email) dto.email = request.payload.email;
                    if (request.payload.password) dto.password = request.payload.password;
